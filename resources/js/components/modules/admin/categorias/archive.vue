<template>
  <section class="container col-12 mt-3">
    <div class="col-12 border rounded pt-2 bg-white pb-5">
      <h2 class="m-0 admin-title">Lote de Categor&iacute;as</h2>
      <hr class="mt-0" />
      <!-- Form -->
      <section
      ...
      >
        <div class="col-12">
          <p class="text-justify">
            <code
              >Para cargar un lote de categor&iacute;as deber&aacute; cargar un
              archivo en formato <b>xlsx.</b></code
            >
          </p>
          <p class="text-justify">
            <code
          ...
          <ul>
            ...
            <li>
              ...
              <ol>
                ...
                <li>
                  <small
                    >descripcion: (alfanumérico no mayor a 255
                    caracteres)</small
                  >
                </li>
                <li>
                  <small
                    >tipo: debe ser numérico (1 productos, 2 servicios)</small
                  >
                </li>
                <li>
                  <small
    ...
    >
      <p class="text-nowrap">
        Tenga en cuenta que las categorías con nombre repetido no se generarán.
      </p>
  ...
  methods: {
    ...
    verifyFile(data) {
      ...
      if (data.length <= 0) {
        ...
        validate = false;
      } else if (Object.keys(data[0]).length > 4) {
        this.$toastr.error("Error ", "El archivo tiene más de 4 Columnas");
        validate = false;
      } else {
      ...
      axios
        ...
        .then((response) => {
          if (response.data) {
            this.$toastr.success(
              "Satisfactorio ",
              "Las categorías han sido creadas satisfactoriamente."
            );
            setTimeout(() => {
              location.reload();
            }, 3000);
    ...
    downloadFile() {
      axios
        .get("/download/examples/demo_categories.xlsx", {
        ...
        .then((response) => {
          ...
          link.download = "demo_categories.xlsx";
          link.click();
        });
    },
  },
